                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <ul class="list-unstyled lh-7">
                            ...
                            <li class="d-flex justify-content-between">
                                ...
                                <span class="tx-success tx-semibold tx-uppercase">@if($sales->PaymentStatus == 'UNPAID') UNPAID @else {{$sales->PaymentStatus}} @endif 
                                ...
                                <div class="tab-pane fade" id="nav-card" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <table class="table table-borderless mb-3 border small" id="tb_paynamics">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <form name="ePayment" @if(isset($_GET['xgiNdSjGYf'])) style="display:none;" @endif id="ePayment" action="https://payment.ipay88.com.ph/epayment/entry.asp" method="post">
                                                    ...
                                                    <form @if(!isset($_GET['xgiNdSjGYf'])) style="display:none;" @endif action="{{route('paymaya.pay')}}" id="form_pamaya" method="post" enctype="multipart/form-data">
                                                        @csrf
