                    ...
                    <div class="table-responsive mt-20">
                        ...
                        <table class="table table-invoice bd-b" style="font-size:14px;">
                            ...
                            @if($salesPayments->sum('amount') > 0)
                                <tr style="font-weight:bold;">
                                    <td colspan="4">&nbsp;</td>
                                    <td align="right">Total Paid: {{number_format($salesPayments->where('status','PAID')->sum('amount'), 2)}}</td> 
                                </tr>
                            @endif
                            </tbody>
                        </table>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <form name="ePayment" id="ePayment" action="https://payment.ipay88.com.ph/epayment/entry.asp" method="post">
                                                        ...
                                                        <input type="hidden" name="RefNo" id="RefNo" value="{{$sales->id}}">
                                                        ...
                                                        <input type="hidden" name="UserName" id="UserName" value="{{$sales->email}}">
                                                ...
                                                <td colspan="2">
                                                    <form action="{{route('payment.add.store_customer')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required="required" min="0.00" readonly="readonly" value="{{$sales->gross_amount}}" class="form-control" id="oamount" name="amount">
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <td colspan="2">
                                                    <form action="{{route('payment.add.store_customer')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group" id="money_transfer_div">
                                                            ...
                                                            <select class="form-control" name="pamenty_mode" id="pamenty_mode" onchange="if($(this).val()=='GCash'){$('#gcash_details').show(); }">
                                                                <option value="">Select</option>
                                                                <option value="PayMaya" style="display:none;">PayMaya</option>
