                                ...
                                @forelse($products as $product)
                                    ...
                                    <div class="col-lg-3 col-sm-4 col-6 order-page-wrapper d-flex">
                                        <div class="d-flex flex-fill">
                                            <a href="@if($prod_stat == 0) javascript:void(0); @else {{$prod_url}} @endif" title="@if($prod_stat == 0) Product Unavailable @endif">
                                                <div class="card order-page-items flex-fill">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @if($prod_stat > 0)
                                                            @if($product->for_sale_web > 0)
                                                                <div class="btn-group">
                                                                    <a href="#" class="btn btn-sm btn-warning btn-buy-now text-white" onclick="buyNow({{$main->id}});">Buy Now</a>
                                                                    <a href="#" class="btn btn-sm btn-green" onclick="addCart({{$main->id}});">Add to Cart</a>
                                                                </div>
                                                            @endif
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="cart-box">
                                                                    <div class="">
                                                                        <div class="form-group" style="text-align:left;">
                                                                            ...
                                                                            <div class="input-group qty-spin">
                                                                                <div class="input-group-prepend">
                                                                                    <button type="button" class="btn btn-secondary btn-number minus-btn" disabled="disabled" data-type="minus" data-field="qty{{$product->id}}">-</button>
                                                                                </div>
                                                                                <input type="text" name="qty{{$product->id}}" id="qty{{$product->id}}" class="form-control input-number quantity-fld text-center" value="1" min="1" max="1000" onchange="item_qty({{$main->id}});">
                                                                                <div class="input-group-append">
                                                                                    <button type="button" class="btn btn-secondary btn-number plus-btn" data-type="plus" data-field="qty{{$product->id}}">+</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group" style="text-align:left;">
                                                                            ...
                                                                            <form id="misc_form{{$product->id}}">
                                                                                <div class="input-group mb-3">
                                                                                    <select class="form-control custom-select" id="misc{{$product->id}}" placeholder="Select.." required="required" name="misc">
                                                            ...
                                                            <div class="col-md-6">
                                                                <form id="cart_frm{{$product->id}}">
                                                                    @csrf
                                                                    <input type="hidden" value="0" name="ac_paella" id="ac_paella{{$product->id}}">
                                                                    ...
                                                                    <div class="cart-box">
                                                                        <div class="delivery">
                                                                            ...
                                                                            <input type="hidden" id="misc_cntr{{$product->id}}" name="misc_cntr" value="0">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-warning btn-buy-now text-white w-100" id="btn-buy-now-{{$main->id}}" onclick="add_to_cart('buynow',{{$main->id}})" style="display:none;">Buy Now</button>
                                                        <button type="button" class="btn btn-green w-100" id="btn-add-to-cart-{{$main->id}}" onclick="add_to_cart('addcart',{{$main->id}})" style="display:none;">Add to Cart</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
