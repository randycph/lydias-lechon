                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <form id="misc_form">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <button class="btn btn-green" type="submit" id="add_misc">Add</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    ...
                                                    <div class="delivery">
                                                        ...
                                                        @if($product->for_sale > 0)
                                                            <div class="jun" style="text-align:center">
                                                                <button type="button" id="buynowbtn" class="btn btn-warning btn-buy-now text-white"><i class="fa fa-handshake"></i> Buy Now</button>
                                                                <button type="button" id="addcartbtn" class="btn btn-green"><i class="fa fa-cart-plus"></i> Add to Cart</button>
