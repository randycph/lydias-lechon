...
@section('content')
    <div class="menu-page">
                    ...
                    <ul id="nav">
                        @foreach($categories as $category)
                            ...
                            <li class="@if($loop->iteration == 1) current @endif">
                                <a href="#category_{{$category->category_id}}">{{$category->category->name}}</a>
                            </li>
                            @endif
        ...
        <div class="container">
            ...
            @foreach($categories as $category)
                <div class="section-wrapper" id="category_{{$category->category_id}}">
                    @if($category->category->status == 'PUBLISHED')
                    <div class="section">
                        <h4 class="category-heading">{{ $category->category->name }}</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <form id="cart_frm{{$main->id}}">
                                                            ...
                                                            <input type="hidden" value="addcart" name="action" id="action{{$main->id}}">
                                                            <div class="cart-box">
                                                                <div class="delivery">
