                ...
                <div class="row">
                    <div class="col-md-6" style="font-family:sans-serif, arial;">                
                            ...
                            <div class="form-group">
                                <label for="shipping_type" class="control-label">Full Name *:</label>
                                <input type="text" class="form-control" id="name" name="gfullname" required>
                            </div> 
                            <div class="form-group">
                                <label for="shipping_type" class="control-label">Contact No. *:</label>
                                <input type="number" class="form-control" id="contact" name="gcontact" required>
                            </div> 
                            <div class="form-group">
                                <label for="shipping_type" class="control-label">Email *:</label>
                                <input type="text" class="form-control" id="email" name="gemail" required>
                            </div>                     
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="shipping_type" id="shipping_type" class="form-control" required="required">
                                    @if(Setting::info()->disable_delivery == 0)
                                        <option value="d2d" @if (session('delivery_option') == 'delivery') selected="selected" @endif>Door to door delivery</option>
                                    @else
                                    ...
                                    @if(Setting::info()->disable_order == 0)
                            ...
                            <div id="d2d_div" @if (session('delivery_option') == 'pick-up')  style="display:none;" @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="orig form-control" value="" name="uname1" id="uname1" required="">
                                </div>
                                <div class="form-group">
                                    <label for="mobile" class="control-label">Contact Number *</label>
                                    <input type="number" class="orig form-control" value="" name="mobile" id="mobile" required="required">
                                </div>                            
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="delivery_address" id="delivery_address" class="orig form-control" cols="30" rows="4"></textarea>
                                </div> 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" id="minimum_order_pickup" value="{{Setting::info()->minimum_order_pickup}}">
                        <table class="table">
                            <tr>
                                <td>Order</td>
                                <td align="right">
                        ...
                        <div class="form-group text-right">                            
                            ...
                            <input type="hidden" step="0.01" class="form-control text-right" value="{{number_format($products->sum('itemTotalPrice'),2,'.','')}}" name="deposit" id="deposit">
                             <a class="btn btn-info" href="javascript:void(0);" onclick="pay_now();">Submit</a>
      ...
      <div class="modal-body">
        <nav class="px-4">
            <div class="row nav nav-tabs payment border-0" id="nav-tab" role="tablist">
                ...
                <div class="col-12 tab-content mt-4" id="nav-tabContent">

                    <div class="tab-pane fade" id="nav-card" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <table width="80%" class="table table-borderless mb-3 border small" id="tb_paynamics">
                            <tbody>
                                <tr class="border">
                                    ...
                                    <td colspan="2">
                                        <form name="ePayment" id="ePayment" style="display:none;" action="https://payment.ipay88.com.ph/epayment/entry.asp" method="post">
                                            ...
                                            <tr class="border" style="display:none;">                                  
                                              <td colspan="2" class="text-right"><a href="javascript:void(0)" onclick="$('#ePayment').submit()" class="btn btn-primary">Pay Now</a></td>
                                            </tr>
                                        </form>
                    ...
                    <div class="tab-pane fade" id="nav-bank" role="tabpanel" aria-labelledby="nav-home-tab">  
                        <form action="{{route('payment.add.store_customer')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="sales_header_id" class="sales_header_id" value="">  
                            <table width="80%" class="table table-borderless mb-3 border small" id="tb_bankdeposit">
                                <tbody>
                                    <tr class="border">
                                        <td colspan="2"><span class="m-0 h6"  style="color:#f26522;"><strong>Payment</strong></span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label for="" class="col-form-label">Amount to Pay:</label>
                                                <input type="number" required="required" min="0.00" step="0.01" readonly="readonly" class="form-control oamount" name="amount">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="tab-pane fade" id="nav-transfer" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <form action="{{route('payment.add.store_customer')}}" id="form_gpay" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="sales_header_id" class="sales_header_id" value="">   
                            <table width="80%" class="table table-borderless mb-3 border small" id="tb_moneytransfer" >
                                <tbody>
                                    <tr class="border">
                                        <td colspan="2"><span class="m-0 h6"  style="color:#f26522;"><strong>Payment</strong></span></td>
                    ...
                    <div class="tab-pane fade" id="nav-center" role="tabpanel" aria-labelledby="nav-profile-tab">  
                        <form action="{{route('payment.add.store_customer')}}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="sales_header_id" class="sales_header_id" value="">                
                            <table width="80%" class="table table-borderless mb-3 border small" id="tb_paymentcenter">
                                <tbody>
                                    <tr class="border">
                                        <td colspan="2"><span class="m-0 h6"  style="color:#f26522;"><strong>Payment</strong></span></td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Our delivery service has already reached it's maximum, please be informed that all orders for December 22, 23, 24, 25, & 31 is on a store pick up basis only.</p>
...
<div class="modal fade" id="cochimodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">To our valued customers!</h5>
      ...
      <div class="modal-body">
        ...
        <p>To our Valued Customer,
        Happy Holidays!
        Due to Influx of Cochinillo orders for December 22,23,24,25,31 & Jan 1, we regret to inform you that this item in unavailable for these dates. We are sorry for the inconvenience.
       
        We hope for your kind understanding. Thank you for ordering from Lydia's Lechon!</p>
...
<input type="hidden" name="has_cochi" id="has_cochi" value="{{$has_cochi}}">
@endsection
...
@section('jsscript')
    ...
    function check_disable_dates(){
        //var disable_dates = ["2020-12-24","2020-12-25","2020-12-31","2021-12-24","2021-12-25","2021-12-31","2023-12-22","2023-12-23","2023-12-24","2023-12-25","2023-12-31"];
        var disable_dates = ["2020-12-24","2020-12-25"];
        ...
        var disable_cochi_dates = ["2023-12-22","2023-12-23","2023-12-24","2023-12-25","2023-12-31","2024-01-01"];
    
        if($.inArray($('#need_date').val(), disable_cochi_dates) > -1 && $('#has_cochi').val() == 1){
            
            $('#cochimodal').modal('show');
            $('#need_date').val("");
        }
    ...
    function pay_now() {      
        ...
        if($('#shipping_type').val()==''){
            ...
            if(parseFloat($('#minimum_order_pickup').val()) > parseFloat($('#total_amount').val())){
                alert('A minimum of Php '+$('#minimum_order_pickup').val()+' is required in order to checkout your order.');
                return false;
            }
        }
        ...
        $.ajax({
            ...
            success: function(returnData) {
                ...
                if (returnData['success']) {
                    ...
                    $('#UserName').val(returnData['customer_name']);
