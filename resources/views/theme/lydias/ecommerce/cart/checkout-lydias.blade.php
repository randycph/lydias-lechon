                    ...
                    <div class="col-md-6" style="font-family:sans-serif, arial;">                
                            ...
                            <div id="d2d_div" @if (session('delivery_option') == 'pick-up')  style="display:none;" @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="orig form-control" value="@if(Auth::user()->is_org == 1){{$user->contact_person}} @else {{$user->firstname}} {{$user->lastname}} @endif" name="uname1" id="uname1" required="">
                                </div>
                                <div class="form-group">
                              ...
                              <td colspan="2">
                                <form style="display:none;" name="ePayment"  id="ePayment" action="https://payment.ipay88.com.ph/epayment/entry.asp" method="post">
                                    <div class="form-group">                                
                                        ...
                                        <input type="number" readonly="readonly" min="0.00" step="0.01" class="form-control" id="Amount2" name="Amount2">
                                    </div>
