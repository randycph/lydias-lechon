                    ...
                    <div class="tab-pane fade" id="nav-card" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <table width="80%" class="table table-borderless mb-3 border small" id="tb_paynamics">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <form name="ePayment" id="ePayment" action="https://payment.ipay88.com.ph/epayment/entry.asp" method="post">
                                            <div class="form-group">                                
                                        ...
                                        <form action="{{route('paymaya.pay')}}" style="display:none;" id="form_pamaya" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="sales_header_id" class="sales_header_id" value="">   
                                            <table style="display:none;" width="80%" class="table table-borderless mb-3 border small">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
