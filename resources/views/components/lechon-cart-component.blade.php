            ...
            <div class="flex justify-between items-center px-3">
                <div>
                    <div class="mt-2 flex">
                        ...
                        <a id="share-facebook" target="_blank" class="fill-gray-600 hover:fill-gray-500">
                        ...
                        <a href="https://www.instagram.com/lydiaslechon" id="share-instagram" target="_blank" class="ml-3 fill-gray-600 hover:fill-gray-500">
                        ...
                        <a href="https://www.youtube.com/@lydias_lechon" target="_blank" class="ml-3 fill-gray-600 hover:fill-gray-500">
                        ...
                        <a href="https://share.google/6Du4hxNHkWY4Sh64A" target="_blank" class="ml-3 fill-gray-600 hover:fill-gray-500">
                            <span class="sr-only">Google</span>
                            <svg class="h-6 w-6 " role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Google</title><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z"/></svg>
                        </a>

                        <a href="https://linkedin.com/company/lydias-lechon" class="ml-3 fill-gray-600 hover:fill-gray-500">
                            <svg class="h-6 w-6 " role="img" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>linkedin</title>
                                <defs></defs>
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -7479.000000)"  class="fill-gray-600 hover:fill-gray-500">
                        ...
                        <a href="https://www.tiktok.com/@lydias_lechon" id="share-tiktok" class="ml-3 fill-gray-600 hover:fill-gray-500">
            ...
            <div class="mt-4 px-4 flex flex-col lg:flex-row gap-4 lg:gap-10">
                ...
                <div class="lg:w-1/2 w-full ">
                    ...
                    <div class="mt-10">
                        ...
                        @else
                        <button @click="added = true; add_to_cart('addcart', product.id, quantity, addons);" :disabled="loading" 
                            class="bg-primary primary-btn text-white w-full px-6 py-3 rounded-md font-semibold flex items-center justify-center gap-2 transition-all duration-300 ease-in-out custom-btn btn-primary disabled:opacity-50 disabled:cursor-not-allowed">
                            <template x-if="!added">
        ...
        return {
            ...
            setSocialShareLinks() {
                ...
                document.getElementById("share-instagram").href =
                    `https://www.instagram.com/lydiaslechon/`;

                document.getElementById("share-tiktok").href =
                    `https://www.tiktok.com/@lydias_lechon`;
            }
        }
    }
</script>
