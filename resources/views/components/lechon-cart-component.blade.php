                    ...
                    <div class="flex lg:justify-between flex-col lg:flex-row justify-start items-start mb-5 lg:mt-0">
                        ...
                        <div>
                            <div class="mt-2 flex">
                                ...
                                <a id="share-instagram" target="_blank" class="ml-3 fill-gray-600 hover:fill-gray-500">
                                ...
                                <a id="share-twitter" class="ml-3 fill-gray-600 hover:fill-gray-500">
                                ...
                                <a id="share-tiktok" class="ml-3 fill-gray-600 hover:fill-gray-500">
        ...
        return {
            ...
            setSocialShareLinks() {
                ...
                document.getElementById("share-tiktok").href =
                    `https://www.tiktok.com/@lydiaslechon`;
            }
        }
    }
</script>
