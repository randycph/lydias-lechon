    <div 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4 lechons pb-10 container">
            @foreach ($products as $product)
                <!-- Equal-height card -->
                <div class="bg-white shadow-md rounded-lg border border-primary lechon flex flex-col h-full">

                <!-- Consistent image area -->
                <img
                    src="{{ asset('storage/products/' .  $product->photos?->last()?->path) }}"
                    alt="{{ $product->name }}"
                    class="w-full h-56 lg:h-64 object-contain px-4 pt-4"
                ...
                <!-- Divider under title+price (will align across cards) -->
                <div class="border-t border-primary border-opacity-50 mt-4"></div>
                ...
                <div class="mt-2 flex flex-col gap-2 p-4">
                    ...
                    <div class="flex items-center text-primary gap-2">
                        ...
                        <g clip-path="url(#clip0_73_19609)"><path d="M9.5 4C9.5 3.33696 9.23661 2.70107 8.76777 2.23223C8.29893 1.76339 7.66304 1.5 7 1.5C6.33696 1.5 5.70107 1.76339 5.23223 2.23223C4.76339 2.70107 4.5 3.33696 4.5 4C4.5 4.66304 4.76339 5.29893 5.23223 5.76777C5.70107 6.23661 6.33696 6.5 7 6.5C7.66304 6.5 8.29893 6.23661 8.76777 5.76777C9.23661 5.29893 9.5 4.66304 9.5 4ZM3 4C3 2.93913 3.42143 1.92172 4.17157 1.17157C4.92172 0.421427 5.93913 0 7 0C8.06087 0 9.07828 0.421427 9.82843 1.17157C10.5786 1.92172 11 2.93913 11 4C11 5.06087 10.5786 6.07828 9.82843 6.82843C9.07828 7.57857 8.06087 8 7 8C5.93913 8 4.92172 7.57857 4.17157 6.82843C3.42143 6.07828 3 5.06087 3 4ZM1.54062 14.5H12.4625C12.1844 12.5219 10.4844 11 8.43125 11H5.575C3.52187 11 1.82188 12.5219 1.54375 14.5H1.54062ZM0 15.0719C0 11.9937 2.49375 9.5 5.57188 9.5H8.42813C11.5063 9.5 14 11.9937 14 15.0719C14 15.5844 13.5844 16 13.0719 16H0.928125C0.415625 16 0 15.5844 0 15.0719Z" fill="#018441"/></g>
                        <defs><clipPath id="clip0_73_19609"><rect width="14" height="16" fill="white"/></clipPath></defs>
                        </svg>
                    ...
                    <div class="flex items-center text-primary gap-2">
                        ...
                        <g clip-path="url(#clip0_73_19618)"><path d="M14.764 0.225889C15.0787 0.527075 15.0787 1.0141 14.764 1.31208L5.92669 9.77411C5.61203 10.0753 5.10321 10.0753 4.7919 9.77411L0.235996 5.41653C-0.0786655 5.11535 -0.0786655 4.62832 0.235996 4.33034C0.550658 4.03236 1.05947 4.02916 1.37079 4.33034L5.35427 8.14322L13.6259 0.225889C13.9405 -0.0752964 14.4493 -0.0752964 14.7607 0.225889H14.764Z" fill="#018441"/></g>
                        <defs><clipPath id="clip0_73_19618"><rect width="15" height="10" fill="white"/></clipPath></defs>
                        </svg>
                ...
                <!-- CTA fixed to bottom -->
                <div class="mt-auto border-t border-primary">
                    ...
                    @else
                    <button @click="show(@js($product))" class="text-primary px-4 py-3 lg:py-5 w-full custom-btn btn-primary text-base lg:text-xl">
                        Add to Cart
                    </button>
                    @endif
                </div>
