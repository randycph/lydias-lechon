...
x-data="{
    ...
    @else
        ...
        <div class="hidden md:flex text-white text-lg gap-6">
            <a href="{{ route('lechon-menu') }}" class="uppercase">
                Menu
            </a>
            <a href="{{ route('lechon-pricelist') }}" class="uppercase">
                Lechon Pricelist
            </a>
            <a href="{{ route('our-stores') }}" class="uppercase">
                Stores
            </a>
