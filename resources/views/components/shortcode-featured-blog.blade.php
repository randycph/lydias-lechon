<div class="relative mx-auto pb-12">
    <div class="bg-tertiary container">
        <div class="flex flex-col lg:flex-row">
            <img class="w-full lg:w-1/2" src="{{ $featuredBlog?->image_url ?? $featuredBlog?->thumbnail_url }}" alt="Lydiandary the story of how a little girl’s idea became the world famous Lydia’s Lechon">
