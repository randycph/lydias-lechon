            ...
            <div class="flex flex-col mt-5" x-data="voiceSearch()" @voice-search-finished.window="">
                ...
                <form class="flex items-center px-4 lg:px-6 pt-16 w-full flex-col lg:flex-row gap-2" >   
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" x-model="search" id="voice-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-16 px-2.5 py-3.5  " placeholder="Search Lechon and more..." required />
