...
<footer class="fixed bottom-1 left-1/2 transform -translate-x-[50%] w-[90%] bg-tertiary text-white px-6 py-3 flex md:hidden justify-between items-center z-40 rounded-full">
