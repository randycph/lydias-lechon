                        ...
                        <div class="mt-4 flex flex-col gap-4">
                            ...
                            <template x-for="(cart, index) in carts" :key="index">
                                <div class="flex justify-between items-center gap-4 hover:bg-gray-100 py-2" >
                                    <div class="flex gap-4 items-center px-6">
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <div class="flex items-center space-x-1">
                                                <!-- Minus Button -->
                                                <button :class="cart.qty <= 1 ? 'invisible' : ''" @click="handleQtyChange(cart.product.id, cart.qty, -1, cart?.product?.paella_price)" class="w-8 h-8 flex items-center justify-center border rounded-md bg-gray-100 text-gray-700">
                                    ...
                                    <div class="pr-2">
                                        <button @click="removeCart(cart?.product?.id, cart?.paella)" class="text-primary">
