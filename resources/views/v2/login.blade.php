            ...
            <div class="pb-20 px-4">
                ...
                <div class="">
                    <div class="flex gap-2 flex-col lg:flex-row items-center justify-center mt-5 w-full">
                        ...
                        <a href="{{ route('facebook.login') }}" class="hover:bg-gray-50 bg-indigo-100 border m-auto border-indigo-100 text-primary px-6 py-4 rounded-md flex justify-center lg:w-max w-full gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 512 512">
