...
@section('content')
    ...
    <div class="py-20 px-4">
        <h1 class="text-4xl font-cubao font-medium text-primary text-center my-10">lechon goodness in every neighborhood</h1>
        <p class="text-center">With over <strong>20 stores</strong> across Metro Manila, Lydia’s Lechon brings our famous roast lechon closer to you. Find your nearest branch and enjoy a taste of Filipino tradition, making every meal a celebration.</p>
    </div>

    <div class="relative mx-auto">
        <div class="swiper-stores overflow-hidden">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="{{ asset('images/store1.png') }}" alt="Lydia's Lechon Store" class="w-full h-[300px] object-cover rounded-md">
                </div>
                <div class="swiper-slide">
                    <img src="{{ asset('images/store2.jfif') }}" alt="Lydia's Lechon Store" class="w-full h-[300px] object-cover rounded-md">
                </div>
                <div class="swiper-slide">
                    <img src="{{ asset('images/store3.png') }}" alt="Lydia's Lechon Store" class="w-full h-[300px] object-cover rounded-md">
                </div>
            </div>
        </div>
    ...
    <div class="px-4 py-16">
        <h2 class="text-3xl font-cubao font-medium text-primary text-center">Head Office</h2>
        ...
        <h2 class="text-3xl font-cubao font-medium text-primary text-center mt-10">our stores and outlets</h2>
        <div class="mt-10">
        ...
        <h2 class="text-3xl font-cubao font-medium text-primary text-center mt-10">sm food court outlets</h2>
        ...
        <div class="mt-10">
            ...
            <div class="flex gap-2">
                <span>FS6, SM Food Court, Felix Huertas St., Corner A.H Lacson Ave., Brgy. 350 Zone 035, Sta. Cruz, Manila</span>
            </div>
            <div class="flex items-center gap-2 py-2 border-b border-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
                    <path fill-rule="evenodd" d="m3.855 7.286 1.067-.534a1 1 0 0 0 .542-1.046l-.44-2.858A1 1 0 0 0 4.036 2H3a1 1 0 0 0-1 1v2c0 .709.082 1.4.238 2.062a9.012 9.012 0 0 0 6.7 6.7A9.024 9.024 0 0 0 11 14h2a1 1 0 0 0 1-1v-1.036a1 1 0 0 0-.848-.988l-2.858-.44a1 1 0 0 0-1.046.542l-.534 1.067a7.52 7.52 0 0 1-4.86-4.859Z" clip-rule="evenodd" />
