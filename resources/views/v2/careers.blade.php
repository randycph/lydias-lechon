...
@section('content')
    ...
    <div class="pt-20 pb-10 px-4">
        <h1 class="text-4xl font-cubao font-medium text-primary text-center my-10">Join the Lydia’s Lechon Family</h1>
        <p class="text-center">At Lydia’s Lechon, we’re always looking for passionate individuals to join our team. Whether you’re starting your career or seeking new challenges, we offer a supportive environment where you can grow. Explore our job openings and be part of our mission to bring joy and delicious lechon to every Filipino home.</p>
    </div>
    ...
    <div class="relative mx-auto px-4">
        ...
        <div class="mx-auto rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-green-700 text-white px-6 py-6 text-center">
                <h2 class="text-2xl font-medium uppercase mb-4 font-cubao">Ready to Join Our Team?</h2>
                <p class="mb-5">
                ...
                <a href="#"
                   class="inline-block bg-tertiary w-full text-white font-semibold rounded-md px-6 py-4 transition">
                    See Our Job Openings
                </a>
            </div>
        
            <div class="bg-white px-6 py-6">
                <h3 class="text-primary text-2xl font-cubao font-medium uppercase mb-4">Apply Now</h3>
        ...
        <div class="mt-10">
            <h2 class="font-cubao text-4xl text-center text-primary">Current Opening/s</h2>
            <hr class="my-5">
