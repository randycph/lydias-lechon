    ...
    <div x-data="{ expanded: false }" class="bg-cream">
        <div class="pb-20 px-4">
            <div class="pt-20 pb-5 px-4">
                <h1 class="text-4xl font-cubao font-medium text-primary text-center mt-10">order confirmation</h1>
                <h3 class="font-medium text-center mt-2">Thank you for ordering with us! Your delicious Lydia's Lechon meal is on its way. We’ll send you an update once it’s ready for pickup or delivery. Your order details has also been sent to your email. Enjoy!</h3>
                <div class="font-medium text-center mt-2">For any inquiries, you may call our <strong class="text-primary">hotline</strong> or <strong class="text-primary">contact us</strong>.</div>
            </div>
            ...
            <div class="rounded-lg border bg-white border-[#DFDFDF] shadow-md mt-10">
                <div class="px-4 py-3 border-b border-[#DFDFDF]">
                    <h2 class="text-lg font-semibold text-left">Order Details</h2>
                </div>
