            ...
            <div class="flex items-start flex-col gap-2  py-5 border-b border-[#DFDFDF]">
                <div x-show="!passwordSuccess">
                    <div class="text-sm text-gray-500 px-6">
                        To change your password, please fill in the fields below. Your password must contain at <strong>least 10 characters</strong>, it must also include at least one upper case letter, one lower case letter, one number and one special character.
                    </div>
                    <div class="px-6 w-full text-sm">
                        <div class="mb-5">
                            <label for="current-password" class="block mb-2 font-bold text-gray-900">Current Password <span class="text-red-800">*</span> </label>
                            <input type="password" id="current-password"
                                class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="" required />
                        </div>
                        <div class="mb-5">
                            <label for="new-password" class="block mb-2 font-bold text-gray-900">New Password <span class="text-red-800">*</span> </label>
                            <input type="password" id="new-password"
                                class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="" required />
                        </div>
                        <div class="mb-5">
                            <label for="confirm-password" class="block mb-2 font-bold text-gray-900">Confirm Password <span class="text-red-800">*</span> </label>
                ...
                <div class="sm:flex sm:items-end" x-show="passwordSuccess">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">Your password has been changed successfully! Use your new password to login</p>
                        </div>
                    </div>
