                    ...
                    <div class="flex flex-col items-center gap-8 px-4 py-3 border-b border-[#DFDFDF] w-full">
                        ...
                        <div class="flex gap-4 items-start w-full relative">
                            <div style="background-image: url('{{ asset('images/checkout-bg.png') }}')"
                                ...
                                <img onerror="this.onerror=null;this.src='{{ asset('images/no-image.jpg') }}'" src="{{ $cart?->product?->photos->first()?->path ? asset('storage/products/' . $cart?->product?->photos->first()->path) : asset('images/no-image.jpg') }}" alt="{{ $cart['name'] ?? $cart?->product?->name }}"
