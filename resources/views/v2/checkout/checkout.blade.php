        ...
        function checkoutForm() {
            ...
            couponRequiredProductQuantity(coupon) {
                const qtyKeys = [
                    ...
                    'couponProductQuantity',
                    'coupon_product_qty',
                    'couponProductQty',
                    'coupon_total_product_quantity',
                    'couponTotalProductQuantity',
                    'coupon_total_product_qty',
                    'couponTotalProductQty',
                ...
                const addSource = (source) => {
                    parseMaybeJson(source).forEach(item => {
                        ...
                        [
                            ...
                            // The admin form can store Total Quantity on the pivot of
                            // the selected purchase product/category relation. These
                            // relation records must be scanned before falling back to
                            // the implicit minimum of 1.
                            ...
                            item.requiredProducts,
                            item.coupon_product,
                            item.coupon_products,
                            item.couponProduct,
                            item.couponProducts,
                            item.products,
                            item.applicable_products,
                            item.applicableProducts,
                            item.eligible_products,
                            item.eligibleProducts,
                            item.buy_product,
                            item.buy_products,
                            item.buyProduct,
                            item.buyProducts,
                            item.purchase_condition_product,
                            item.purchase_condition_products,
                            item.purchaseConditionProduct,
                            item.purchaseConditionProducts,
                            item.minimum_purchase_product,
                            item.minimum_purchase_products,
                            item.minimumPurchaseProduct,
                            item.minimumPurchaseProducts,
                            item.total_quantity_product,
                            item.total_quantity_products,
                            item.totalQuantityProduct,
                            item.totalQuantityProducts,
                            item.purchase_category,
                            item.purchase_categories,
                            item.purchaseCategory,
                            item.purchaseCategories,
                            item.categories,
                            item.applicable_categories,
                            item.applicableCategories,
                            item.eligible_categories,
                            item.eligibleCategories,
                            item.purchase_condition_category,
                            item.purchase_condition_categories,
                            item.purchaseConditionCategory,
                            item.purchaseConditionCategories,
                            item.selected_category,
                            item.selected_categories,
                            item.selectedCategory,
                            item.selectedCategories,
                            item.minimum_purchase_category,
                            item.minimum_purchase_categories,
                            item.minimumPurchaseCategory,
                            item.minimumPurchaseCategories,
                            item.total_quantity_category,
                            item.total_quantity_categories,
                            item.totalQuantityCategory,
                            item.totalQuantityCategories,
                            item.pivot
                        ].forEach(addSource);
                    });
                };
