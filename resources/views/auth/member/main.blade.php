    ...
    <div class="row no-gutters">
        <div class="col-lg-6">
            <div class="signin-hero">
                ...
                <div class="signin-caption">
                    <div class="wd-100p">
                        <h2>Welcome to Lydias Lechon</h2>
        ...
        <div class="col-lg-6">
            <div class="sign-wrapper">
                <div class="wd-100p">
                    <div class="brand mg-b-40">
                        <img src="{{ asset('theme/legande/images/misc/horizontal-black.png') }}" alt="">
                    </div>

                    @yield('content')

                    <div class="cms-footer mg-t-50">
                        <p class="tx-white-5 tx-12">Lydias Lechon<br>
                            Developed by &copy; 2019 WebFocus Solutions, Inc.</p>
                    </div>
                </div>
            </div><!-- sign-wrapper -->
        </div>
