...
<body x-cloak class="bg-gray-100 text-gray-900" x-data="{ open: false, openCart: false }">
    ...
    <div >
        ...
        <div x-show="openCart" x-transition:enter="transition-transform transform duration-300"
            ...
            x-transition:leave="transition-transform transform duration-300"
            x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full"
            class="fixed top-[5%] right-[5%] w-[90%] h-[90%] bg-white text-black z-50 py-6 flex flex-col shadow-lg rounded-lg overflow-x-scroll scrollbar-hide scroll-smooth snap-y">
    ...
    <footer class="fixed bottom-0 left-0 w-full bg-orange-500 text-white flex justify-around p-3 text-sm font-bold z-50">
        ...
        <a href="#" class="text-center">HOTLINE</a>
    </footer>
</body>
</html>
