...
<div class="container pd-x-0">
                        ...
                        @if(auth()->user()->has_access_to_route('albums.destroy_many'))
                            <div class="list-search d-inline">
                                <div class="dropdown d-inline mg-r-10">
                                        ...
                                        <form id="albumsForm" method="POST" action="{{ route('albums.destroy_many') }}">
                                            @method('DELETE')
                                            @csrf
    ...
    {{--                                                <a class="nav-link" href="{{ route('albums.show', $album->id) }}"><i data-feather="eye"></i></a>--}}
                                                        <a class="nav-link" href="{{ route('albums.edit', $album->id) }}"><i data-feather="edit"></i></a>
                                                    @endif
                                                    @if(auth()->user()->has_access_to_route('albums.edit') || auth()->user()->has_access_to_route('albums.destroy'))
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            @if(auth()->user()->has_access_to_route('albums.destroy'))
                                                                ...
                                                                <form id="albumForm{{ $album->id }}" method="POST" action="{{ route('albums.destroy', $album->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                            @endif
