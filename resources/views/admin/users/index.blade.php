                ...
                <div class="filter-buttons mg-b-10">
                    <div class="d-md-flex bd-highlight">
                        <div class="bd-highlight mg-r-10 mg-t-10">
                            ...
                            @if (auth()->user()->has_access_to_route('user.activate'))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <nav class="nav table-options justify-content-end">
                                                ...
                                                @if($user->is_active == 1)
                                                    @if(auth()->user()->has_access_to_route('user.deactivate'))
    ...
    function bulkAction(status){
        ...
        if(parseInt(counter) < 1){
            ...
            $('#btnDeactivateMultiple').on('click', function() {
                post_form("{{route('users.multiple.deactivate')}}", status ,selected_users);
            });
        }
    }
