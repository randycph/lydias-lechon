...
<div class="container pd-x-0">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a
                            href="{{route('admin.locations.index')}}">Delivery Rate</a></li>
    ...
    <div class="row">
        <div class="col-md-6">
            <form id="delivery_form" autocomplete="off" action="{{ route('admin.locations.update',$rate->id) }}"
                method="post">
                @csrf
                @method('PUT')
                ...
                <div class="form-group" id="region_div">
                    ...
                    <select name="item_type" id="item_type" class="form-control" required="required">
                        ...
                        <option value="misc" @if($rate->item_type == 'misc') selected="selected" @endif>Miscellaneous
                        </option>
                        <option value="lechon" @if($rate->item_type == 'lechon') selected="selected" @endif>Lechon
                        </option>
                    </select>
