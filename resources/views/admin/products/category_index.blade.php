                            ...
                            @forelse($categories as $category)
                                <tr id="row{{$category->id}}">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <nav class="nav table-options">
                                                <a class="nav-link" target="_blank" href="{{ env('APP_URL') }}/products-list?type=category&criteria={{$category->id}}" title="View Videos"><i data-feather="eye"></i></a>
                                                ...
                                                @endif
                                                @if (auth()->user()->has_access_to_route('product-categories.destroy'))
