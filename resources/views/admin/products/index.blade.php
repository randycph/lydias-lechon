                            ...
                            @forelse($products as $product)
                                ...
                                <tr id="row{{$product->id}}">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <nav class="nav table-options">
                                                <a class="nav-link" target="_blank" href="{{ url('/menu') }}?product={{$product->slug}}" title="View Product Profile"><i data-feather="eye"></i></a>
                                                ...
                                                @endif
                                                @if (auth()->user()->has_access_to_route('products.destroy'))
