...
{{--                            <textarea required name="long_description" rows="10" class="form-control">{{ old('description',$product->description) }}</textarea>--}}
{{--                            @hasError(['inputName' => 'long_description'])--}}
{{--                            @endhasError--}}
{{--                        </div>--}}
{{--                    <div class="form-group">--}}
...
{{--                                <div class="form-group">--}}
{{--                                    <label>Size</label>--}}
{{--                                    <input class="form-control" type="text" name="size1" id="size1">--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="col-md-3">--}}
{{--                                <div class="form-group">--}}
...
{{--                                    <input class="form-control" type="number" step="0.01" min="0.01" value="0.00" name="price1" id="price1">--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="col-md-2">--}}
{{--                                <div class="form-group">--}}
{{--                                    <label>Paella Price (in Php)</label>--}}
{{--                                    <input class="form-control" type="number" step="0.01" min="0.00" value="0.00" name="paella_price1" id="paella_price1">--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                            <input type="text" class="form-control @error('shipping_fee') is-invalid @enderror" name="shipping_fee" id="shipping_fee" value="{{ old('shipping_fee', number_format($product->shipping_fee,2,'.','')) }}" required>--}}
{{--                            @hasError(['inputName' => 'shipping_fee'])--}}
{{--                            @endhasError--}}
{{--                        </div>--}}
{{--                <div class="col-lg-6">--}}
                    <div class="form-group">
