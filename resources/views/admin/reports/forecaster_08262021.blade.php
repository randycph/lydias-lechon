...
@section('pagetitle')
    ...
    <table width="40%" border="1" style="font-size:14px;font-weight:bold;">
        <tr>
            ...
            <td align="center">{{collect($jo)->where('jo_category','=','Order')->where('is_misc','0')->where('production_item','1')->sum('qty')  + collect($rs)->where('is_misc','0')->where('production_item','1')->sum('qty')}}</td>
        </tr>
        <tr>
            <td>TOTAL PANTAGA:</td>
        ...
        <tr>
            ...
            <td align="center">{{collect($jo)->where('is_misc','0')->where('production_item','1')->whereIn('jo_category',['Order','Pantaga','Display','Alpha Size','Belly Pantaga'])->sum('qty') 
                + collect($rs)->where('is_misc','0')->where('production_item','1')->sum('qty')}}</td>
        </tr>
        <tr>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="item_type" id="item_type" class="form-control">
                                        ...
                                        @forelse(\App\ProductCategory::orderBy('name')->get() as $ca)
