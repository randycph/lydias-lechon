                ...
                <div class="row row-sm align-items-start">
                    ...
                    <div class="table-responsive mg-t-20">
                        ...
                        <table class="table table-invoice bd-b">
                            ...
                            @endif
                            @if($sales->discount_amount > 0 && $sales->has_sub == 0)
                            ...
                            @if($salesDetails->sum('net_amount') > 0)
                                <tr style="font-weight:bold;">
                                    ...
                                    <td class="tx-right">₱{{number_format($salesDetails->sum('net_amount') + $sales->delivery_fee_amount - ($sales->has_sub == 0 ? $sales->discount_amount : 0), 2)}}</td>
                                </tr>
                            @endif
                            </tbody>
                        </table>
