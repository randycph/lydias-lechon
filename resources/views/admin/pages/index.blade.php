                ...
                <div class="filter-buttons">
                    <div class="d-md-flex bd-highlight">
                        <div class="bd-highlight mg-r-10 mg-t-10">
                            ...
                            @if(auth()->user()->has_access_to_route('pages.change.status') && auth()->user()->has_access_to_route('prompt-multiple-delete'))
                                <div class="list-search d-inline">
                                    <div class="dropdown d-inline mg-r-10">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            @endif
                                            @if(auth()->user()->has_access_to_route('prompt-multiple-delete'))
                        ...
                        <table class="table mg-b-0 table-light table-hover">
                            ...
                            <tbody>
                                @forelse($pages as $page)
                                    <tr id="row{{$page->id}}" class="@if($page->page_type != 'default') row_cb @endif">
                                        <th>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input @if($page->page_type != 'default') cb @endif" id="cb{{$page->id}}" @if($page->page_type == 'default') disabled @endif >
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <nav class="nav table-options justify-content-end">
                                                    ...
                                                    @if(auth()->user()->has_access_to_route('pages.edit') && $page->is_editable())
                                                        <a class="nav-link" href="{{route('pages.edit',$page->id)}}" title="Edit Page"><i data-feather="edit"></i></a>
                                                    @endif
                                                    @if(auth()->user()->has_access_to_route('pages.change.status')|| auth()->user()->has_access_to_route('pages.destroy'))
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            @if(auth()->user()->has_access_to_route('pages.change.status'))
                                                                ...
                                                                @endif
                                                            @endif
                                                            @if(auth()->user()->has_access_to_route('pages.destroy') && $page->page_type == 'standard')
