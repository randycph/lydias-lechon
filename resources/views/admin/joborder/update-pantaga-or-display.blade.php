...
<div class="container pd-x-0">
    <div class="d-sm-flex justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
            ...
            <h4 class="mg-b-0 tx-spacing--1">Update Pantaga/Display</h4>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                <form>
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="qty" value="{{number_format($jo->qty,2)}}" step="0.01" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker mg-b-5" data-style="btn btn-outline-light btn-md btn-block tx-left" title="Choose category" data-width="100%" name="jo_category" required="required">
                            ...
                            <option value="{{$jo->jo_category}}" selected="selected">{{$jo->jo_category}}</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label class="d-block">Production Branch <span class="tx-danger">*</span></label>
                        <select class="selectpicker mg-b-5" data-style="btn btn-outline-light btn-md btn-block tx-left" title="Select production branch" data-width="100%" name="prodbranch_id" required="required">
                            @foreach($prod_branches as $branch)

                                <option value="{{$branch->id}}"
                                    @if($branch->id == $po->branch_id) selected="selected" @endif
                                >{{$branch->name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker mg-b-5" data-style="btn btn-outline-light btn-md btn-block tx-left" title="Select branch" data-width="100%" name="branch_id" required="required">
                    ...
                    <div class="form-row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                value="{{date('Y-m-d',strtotime($po->delivery_date))}}" required="required">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group timepicker">
                                    <select class="selectpicker" data-style="btn btn-outline-light btn-md btn-block tx-left" title="Choose time" data-width="100%" name="production_time" required="required">
                                        ...
                                        <option value="{{date('H:i',strtotime($po->delivery_date))}}" selected="selected">{{date('h:i A',strtotime($po->delivery_date))}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                value="{{date('Y-m-d',strtotime($jo->date_needed))}}" required="required">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="d-block">&nbsp;</label>
                                <div class="input-group timepicker">
                                    <select class="selectpicker" data-style="btn btn-outline-light btn-md btn-block tx-left" title="Choose time" data-width="100%" name="time_needed" required="required">
                                        <option value="07:00">07:00 AM</option>
                                        <option value="12:00">12:00 NN</option>
                                        <option value="14:00">02:00 PM</option>
                                        <option value="17:00">05:00 PM</option>
                                        ...
                                        <option value="22:00">10:00 PM</option>
                                        <option value="23:00">11:00 PM</option>
                                        <option value="{{date('H:i',strtotime($jo->date_needed))}}" selected="selected">{{date('h:i A',strtotime($jo->date_needed))}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
