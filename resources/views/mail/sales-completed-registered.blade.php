...
<head>
      ...
      <title>Lydias - Sales Transaction</title>
...
<body>
      <table class="body">
            <tr>
                        ...
                        <table class="container content" align="center">
                              <tr>
                                    <td>
                                          <table>
                                                <tr>
                                                      <td style="text-align: center !important !important;"><img src="{{asset('images/lydias-lechon-logo-small.jpg')}}" alt="Lydias Lechon" /></td>
                                                </tr>
                                          </table>
                                          ...
                                          <table class="row note">                        
                                                <tr>
                                                      <td class="wrapper last">
                                                            ...
                                                            <p class="mg-b-3 tx-semibold">Customer: {{$h->customer_name}}</p>                  
                                                            <p class="mg-b-3">Contact No: {{$h->customer_contact_number}}</p>
                                                            @if($h->customer_name <> $h->contact_person)
                                                            <p class="mg-b-3">Contact Person: {{$h->contact_person}}</p>
                                                            @endif
                                                      ...
                                                      <table class="twelve columns" style="margin-bottom: 10px">
                                                            <tr>
                                                                  <td class="panel">
                                                                        <a href="{{ route('order-history') }}">{{ route('order-history') }}</a>
                                                                  </td>
                                                                  <td class="expander">
                                                                  </td>
                                                            </tr>
                                                                  ...
                                                                  <td>
                                                                        ...
                                                                        <table width="100%" style="font-size:11px;">
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left" style="font-size:11px;padding: 3px;">{{ !empty($details->delivery_date) ? date('F d, Y H:i A', strtotime($details->delivery_date)) : '' }}</td>
                                                                                    <td align="left" style="font-size:11px;padding: 3px;">{{ number_format((float) ($details->qty ?? 0), 0) }}</td>
                                                                                    <td align="left" style="font-size:11px;padding: 3px;">{{ number_format(((float) ($details->paella_price ?? 0) + (float) ($details->price ?? 0)), 2) }}</td>
                                                                                    <td align="left" style="font-size:11px;padding: 3px;">{{ number_format((float) ($details->gross_amount ?? 0), 2) }}</td>                               
                                                                              </tr>
                                                                              @empty
                                                                              <tr>
                                                                                    ...
                                                                                    @if($couponRows && count($couponRows) > 0)
                                                                                          ...
                                                                                          <tr>
                                                                                                <td class="tx-left" colspan="6" style="font-size:11px; padding-left: 20px;">
                                                                                                      {{ empty($coupon->coupon_id) ? 'Gift Certificate' : 'Coupon' }} (<i>{{ $coupon->coupon_code ?? 'N/A' }}</i>)
                                                                                                </td>
                  ...
                  <!-- END: Content -->
                  <!-- BEGIN: Footer -->
                  <table class="page-footer" align="center" style="margin-top:20px;">
                        <tr>
