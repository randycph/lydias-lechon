...
<div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
    ...
    <div style="padding:30px 60px;">
        <div style="text-align: center;padding: 20px 0px;">
            <img src="{{  str_replace(' ', '%20', \App\Helpers\Webfocus\Setting::get_company_logo_storage_path()) }}" alt="company logo" width="175" />
        </div>
...
{{--        </p>--}}
    ...
    <div style="padding-top: 30px;background: #fff;margin-top: 20px;border-top: solid 1px #eee;text-align: center;color: #aaa;">
