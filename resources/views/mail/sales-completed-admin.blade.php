                                          ...
                                          <table class="row note">                        
                                                <tr>
                                                      <td class="wrapper last">
                                                            <h4>A new order has been placed.</h4>
                                                      ...
                                                      <table class="twelve columns" style="margin-bottom: 10px">
                                                            <tr>
                                                                  <td class="panel">
                                                                        <a href="{{env('APP_URL')}}/view/admin/{{$h->order_number}}">
                                                                              {{env('APP_URL')}}/view/admin/{{$h->order_number}}</a>
                                                                        </td>
                                                                        <td class="expander">
                                                                        </td>
                                                                  </tr>
                                                                        ...
                                                                        <td>
                                                                              ...
                                                                              <table width="100%" style="font-size:11px;">
                                                                                    ...
                                                                                    <tr>
                                                                                          ...
                                                                                          <td align="left" style="font-size:11px;padding: 3px;">{{$details->product_name}} @if($details->paella_price > 0) with paella @endif </td> 
