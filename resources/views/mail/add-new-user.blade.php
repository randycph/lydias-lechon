...
<div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
    ...
    <div style="padding:30px 60px;">
        <div style="text-align: center;padding: 20px 0;">
            <img src="https://lydiaslechon.ph/wp-content/uploads/2019/01/new-logo-3.png" alt="company logo" width="175" />
        </div>
        ...
        <div style="text-align: center;">
            <a href="{{ url('password/reset', $token) }}?email={{ $user->email }}&user=new" target="_blank" style="padding: 10px 20px; background: #0349fc; color: #fff;text-decoration: none;font-size: 14px; border-radius: 3px;">Activate my account</a>
        </div>
