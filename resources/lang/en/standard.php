...
return [
    ...
    'services' => [
        'service_type' => [
            ...
            'create_success' => 'The service type has been added.',
            'single_delete_success' => 'The service has been deleted.',
            'restore_success' => 'The service has been restored.',
            'status_update_success' => 'The service has been changed to :STATUS',
            'multiple_status_update_success' => 'Selected services has been changed to :STATUS',
            'multiple_delete_success' => 'Selected services has been deleted.',
            'update_success' => 'The service has been updated.',
        ],
    ],

    'members' => [
        'service_request' => [
            'create_success' => 'The service request has been added.',
            'cancel_success' => 'The service request has been cancelled.',
            'update_success' => 'The service request has been updated.',
            'multiple_cancel_success' => 'Selected request(s) has been cancelled.',
            'approve_success' => 'Request hase been approved.',
            'decline_success' => 'Request has been declined.',
        ],

        'communications' => [
            'message_sent' => 'Message has been sent.',
            'delete_success' => 'Message has been deleted.',
        ],

        'autoship' => [
            'delete_success' => 'Selected order has been deleted.',
            'cancel_success' => 'Schedule has been cancelled.',
            'add_order_success' => 'Product has been added.',
            'update_success' => 'Autoship has been updated.',
        ]
    ],

    'forecaster' => [
        'create_success' => 'Order has been submitted on the selected branch.',
        'cancel_success' => 'Order has been cancelled.',
        'order_update_success' => 'Order has been updated.',
        'branch_cancel_order_success' => 'Order has been cancelled.',
        'remove_order_success' => 'Order has been removed.',
        'multiple_remove_order_success' => 'Selected orders has been cancelled.',
    ],

    'joborders' => [
        'create_success' => 'Job Order has been added.',
        'delete_success' => 'Job Order has been deleted',
        'delete_product_success' => 'Product has been removed.',
        'jo_update_success' => 'Job Order has been updated.'
    ]
