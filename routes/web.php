...
Route::get('/used_coupons', [FrontendController::class, 'my_used_coupons'])->name('my-used-coupons');
...
Route::group(['middleware' => ['authenticated', 'cmsUserOnly']], function () {
    ...
    Route::post('/admin/coupon/store','EcommerceControllers\CouponController@store')->name('coupons.store');
