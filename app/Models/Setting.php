...
class Setting extends Model
{
    ...
    protected $fillable = ['api_key', 'website_name', 'website_favicon', 'company_logo', 'company_favicon', 'company_name', 'disable_delivery_misc', 'disable_delivery_misc_dates',
                            ...
                            'is_rating_need_approval', 'is_rating_allow_anonymous','is_display_review_date','minimum_order','disable_order','order_message','disable_delivery','minimum_processing_hours','minimum_processing_hours_misc','announcement','cutoff','kiosk_express_categories','minimum_order_pickup','disable_pickup_dates','disable_delivery_dates', 'minimum_order_misc'];
