...
class Product extends Model
{
    ...
    protected $fillable = ['free', 'upsell', 'sold_out', 'code', 'category_id', 'name', 'slug', 'short_description', 'description', 'currency', 'price', 'size', 'weight', 'no_of_pax', 'for_sale', 'status', 'is_featured', 'uom', 'created_by', 'meta_title', 'meta_keyword', 'meta_description','is_group','paella_price','for_sale_web','for_sale_kiosk','is_misc','production_item' ];
