...
class ReportsController extends Controller
{
    ...
    public function forecaster(Request $request)
    {
        ...
        // Sales
            ...
            where h.id>0 and h.delivery_status<>'Open Date' and d.deleted_at is null and h.deleted_at is null and h.for_deletion = 0 and jo.deleted_at is null and po.deleted_at is null and (h.payment_status = 'PAID' OR h.isConfirm=1) AND h.has_sub = 0
