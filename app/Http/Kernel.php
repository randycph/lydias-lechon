...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'adminOnly' => \App\Http\Middleware\Admin::class,
        'memberOnly' => \App\Http\Middleware\MemberOnly::class,
        'cmsUserOnly' => \App\Http\Middleware\CMSUserOnly::class,
        'incompleteMemberOnly' => \App\Http\Middleware\IncompleteMemberOnly::class,
